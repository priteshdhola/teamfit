//
//  TFOpenActivityViewController.m
//  TeamFit
//
...
@interface TFOpenActivityViewController ()

@end

@implementation TFOpenActivityViewController {
    NSObject *activity;
}
...
{
	[self.delegate openActivityViewControllerDidCancel:self];
}
...
//    
    [self.delegate openActivityViewControllerDidStart:self];
}
